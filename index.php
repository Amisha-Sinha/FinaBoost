    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <li class="nav-item">
          <a class="nav-link" href="calculator.php"> Amount calculator </a>
        </li>
          <li class="nav-item">
...
<h3 style="text-align: center; font-size: 120%; font-weight: bold;"> Connect with Us! </h3>
<form action="feedbackhelp.php" method="POST">
  <div class="mb-3">
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="feed" placeholder=" Share your experience with us!">
</div>
